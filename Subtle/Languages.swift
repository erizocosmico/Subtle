...
let languages = [
    Language(ISO639: "en", name: "English"),
    ...
    Language(ISO639: "el", name: "Greek"),
    Language(ISO639: "it", name: "Italian"),
    Language(ISO639: "ja", name: "Japanese"),
    Language(ISO639: "ko", name: "Korean"),
